...
The [provider-layer7](https://github.com/crossplane/provider-layer7) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-layer7](https://github.com/crossplane-contrib/provider-jet-layer7) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-layer7/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-layer7/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-layer7/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-layer7/blob/main/hack/boilerplate.go.txt)
...
The [provider-layer7](https://github.com/crossplane/provider-layer7)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-layer7/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-layer7/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue layer7s (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-layer7/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Layer7s: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-layer7/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
