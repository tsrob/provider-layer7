...
XPKGS = provider-layer7
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-layer7: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Layer7 CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Layer7 controllers
...
# This target prepares repo for your provider by replacing all "layer7"
